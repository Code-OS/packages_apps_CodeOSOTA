...
* Define how CodeOSOTA should know about the "version". The version must be parseable to a date.
  * Usually, the version is a part of a build name. For example, the 20150426 in the SlimSaber-bacon-5.0.2-20150426.
* Adjust the OTA configuration according to your build name on how should CodeOSOTA parse the version
...
* Find a key in build.prop that represents your device name and set it in the "device_name"
  * CodeOSOTA will search this device name in the OTA xml file
